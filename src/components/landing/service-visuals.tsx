 ...
 *
 * Desktop: starts desaturated/dim, illuminates on group-hover.
 * Mobile: always vivid (hover doesn't apply).
 */
...
function PreviewWrapper({
  ...
  return (
    <div
      className="service-visual relative mt-8 lg:mt-0 w-full overflow-hidden rounded-2xl bg-cream-200/60 gentle-sway"
  ...
  return (
    <PreviewWrapper>
      ...
      >
        ...
        <rect x="110" y="156" width="100" height="32" rx="6" className="service-accent" fill="#C8553D" opacity="0.75" />
        ...
        <circle cx="570" cy="140" r="30" className="service-accent" fill="#C8553D" opacity="0.06" />
        ...
        {[0, 1, 2].map((i) => (
          <g key={i}>
            ...
            <rect x={130 + i * 200} y="365" width="60" height="20" rx="4" className="service-accent" fill={i === 0 ? "#C8553D" : i === 1 ? "#6B7C5E" : "#B87333"} opacity="0.15" />
          </g>
        ))}
      </svg>
    </PreviewWrapper>
  ...
  return (
    <PreviewWrapper>
      ...
      >
        ...
        {/* Cart icon */}
        <rect x="696" y="74" width="16" height="16" rx="4" className="service-accent" fill="#C8553D" opacity="0.2" />
        ...
        <rect x="580" y="325" width="80" height="30" rx="15" className="service-accent" fill="#C8553D" opacity="0.8" />
  ...
  return (
    <PreviewWrapper>
      ...
      >
        ...
        {/* Connection lines */}
        <path d="M200 145 L320 145" className="service-accent" stroke="#C8553D" strokeWidth="2" strokeDasharray="6 4" opacity="0.3" />
        <path d="M420 145 L540 100" className="service-accent" stroke="#6B7C5E" strokeWidth="2" strokeDasharray="6 4" opacity="0.3" />
        <path d="M420 145 L540 190" className="service-accent" stroke="#6B7C5E" strokeWidth="2" strokeDasharray="6 4" opacity="0.3" />
        <path d="M640 100 L720 145" className="service-accent" stroke="#B87333" strokeWidth="2" strokeDasharray="6 4" opacity="0.3" />
        <path d="M640 190 L720 145" className="service-accent" stroke="#B87333" strokeWidth="2" strokeDasharray="6 4" opacity="0.3" />

        {/* Node: Trigger (WhatsApp) */}
        <rect x="100" y="115" width="100" height="60" rx="12" fill="#FDFCFA" className="service-accent" stroke="#C8553D" strokeWidth="1.5" opacity="0.9" />
        ...
        {/* Node: Process (n8n) */}
        <rect x="320" y="115" width="100" height="60" rx="12" fill="#FDFCFA" className="service-accent" stroke="#6B7C5E" strokeWidth="1.5" opacity="0.9" />
        ...
        {/* Node: Action A (Email) */}
        <rect x="540" y="70" width="100" height="60" rx="12" fill="#FDFCFA" className="service-accent" stroke="#B87333" strokeWidth="1.5" opacity="0.9" />
        ...
        <rect x="540" y="160" width="100" height="60" rx="12" fill="#FDFCFA" className="service-accent" stroke="#B87333" strokeWidth="1.5" opacity="0.9" />
        ...
        {/* Node: Result */}
        <rect x="720" y="120" width="60" height="50" rx="25" className="service-accent" fill="#6B7C5E" stroke="#6B7C5E" strokeWidth="1.5" opacity="0.3" />
        <path d="M738 145 L748 155 L762 135" className="service-accent" stroke="#6B7C5E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" />

        {/* Bottom panel — log/output */}
        <rect x="100" y="280" width="620" height="130" rx="10" fill="#2D2926" opacity="0.9" />
        <rect x="120" y="298" width="80" height="8" rx="2" className="service-accent" fill="#6B7C5E" opacity="0.5" />
        ...
        <rect x="120" y="390" width="150" height="6" rx="2" className="service-accent" fill="#C8553D" opacity="0.15" />

        {/* Decorative: data flow dots */}
        <circle cx="260" cy="145" r="3" className="service-accent" fill="#C8553D" opacity="0.4" />
        <circle cx="480" cy="120" r="3" className="service-accent" fill="#6B7C5E" opacity="0.4" />
        <circle cx="480" cy="170" r="3" className="service-accent" fill="#6B7C5E" opacity="0.4" />
        <circle cx="680" cy="145" r="3" className="service-accent" fill="#B87333" opacity="0.4" />
      </svg>
    </PreviewWrapper>
  );
}
  ...
  return (
    <PreviewWrapper>
      ...
      >
        ...
        {/* Sidebar logo */}
        <circle cx="96" cy="58" r="10" className="service-accent" fill="#C8553D" opacity="0.4" />
        ...
        <rect x="630" y="42" width="80" height="28" rx="6" className="service-accent" fill="#C8553D" opacity="0.7" />
        ...
        {[0, 1, 2, 3].map((i) => (
          <g key={i}>
            ...
            <rect x={258 + i * 115} y="132" width="30" height="5" rx="2" className="service-accent" fill={i < 2 ? "#6B7C5E" : "#C8553D"} opacity="0.3" />
          </g>
        ))}
        ...
        {[0, 1, 2, 3, 4].map((i) => (
          <g key={i}>
            <circle cx="622" cy={200 + i * 30} r="5" className="service-accent" fill={["#C8553D", "#6B7C5E", "#B87333", "#6B7C5E", "#C8553D"][i]} opacity="0.2" />
        ...
        <rect x="465" y="392" width="40" height="5" rx="2" className="service-accent" fill="#6B7C5E" opacity="0.15" />
        <rect x="565" y="390" width="50" height="16" rx="4" className="service-accent" fill="#C8553D" opacity="0.12" />
      </svg>
    </PreviewWrapper>
  );
}
  ...
  return (
    <PreviewWrapper>
      ...
      >
        ...
        <circle cx="196" cy="51" r="14" className="service-accent" fill="#C8553D" opacity="0.3" />
        <rect x="220" y="43" width="80" height="8" rx="2" fill="#FAF8F5" opacity="0.5" />
        <rect x="220" y="56" width="50" height="5" rx="2" className="service-accent" fill="#6B7C5E" opacity="0.4" />
        {/* Online dot */}
        <circle cx="273" cy="58" r="3" className="service-accent" fill="#6B7C5E" opacity="0.6" />

        {/* User message 1 */}
        <rect x="340" y="100" width="270" height="50" rx="12" className="service-accent" fill="#C8553D" opacity="0.12" />
        ...
        <circle cx="192" cy="180" r="12" className="service-accent" fill="#6B7C5E" opacity="0.15" />
        ...
        <rect x="240" y="224" width="140" height="5" rx="2" className="service-accent" fill="#6B7C5E" opacity="0.2" />

        {/* User message 2 */}
        <rect x="380" y="270" width="230" height="40" rx="12" className="service-accent" fill="#C8553D" opacity="0.12" />
        ...
        <circle cx="192" cy="340" r="12" className="service-accent" fill="#6B7C5E" opacity="0.15" />
        ...
        <circle cx="580" cy="395" r="12" className="service-accent" fill="#C8553D" opacity="0.6" />
