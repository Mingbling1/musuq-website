      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-6 lg:grid-cols-2 lg:gap-20">
        ...
        <ScrollReveal direction="right" className="order-1 lg:order-2">
          <div className="relative">
            ...
            />
            <div className="absolute bottom-6 left-0 z-20 rounded-2xl border border-warm-800/10 bg-cream-50/95 px-4 py-3 shadow-[0_16px_40px_-14px_rgba(26,26,26,0.3)] backdrop-blur-sm sm:-left-4">
